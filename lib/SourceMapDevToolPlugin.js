...
class SourceMapDevToolPlugin {
	constructor(options) {
		...
		this.sourceMapContext = options.context ? options.context : "";
	...
	apply(compiler) {
		...
		const sourceMapContext = this.sourceMapContext;
			...
			compilation.plugin("after-optimize-chunk-assets", function(chunks) {
				...
				tasks.forEach(function(task) {
					...
					if(sourceMapFilename) {
						...
						const sourceMapUrl = sourceMapContext !== "" ? (sourceMapContext + sourceMapFile) :
